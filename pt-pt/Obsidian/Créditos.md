...
permalink: credits
---
Os nomes não estão listados por quantidade de contribuição, mas por ordem alfabética (ou pelo menos tentamos!).
...
Créditos a estes programadores de plugins por pioneirizarem funcionalidades que foram adaptadas para o Obsidian:
...
A primeira versão do cofre de ajuda foi escrita por Silver. Mais tarde, parte dela foi escrita por [@mediapathic](http://mediapathic.net), com grande ajuda de Reggie. Também recebemos correções dos muitos pares de olhos da comunidade no Discord e no fórum.
...
Aceitamos pull requests para o cofre de ajuda no [nosso repositório de documentação](https://github.com/obsidianmd/obsidian-docs/). As issues são bem-vindas.

### Adicione o seu nome

Se é um tradutor, faça um pull request para adicionar "O seu nome (idioma contribuído)" à secção acima. Por favor, mantenha a lista de nomes por ordem alfabética, obrigado!

Se o seu nome não estiver em inglês e não puder ser listado alfabeticamente, use este formato: `seu-nome-de-utilizador-github, [o seu nome no seu idioma] (nome do idioma)`.

## Reconhecimentos de terceiros

O Obsidian usa as bibliotecas de código aberto abaixo (por ordem alfabética):
...
O logótipo do Obsidian usado antes da v1.3.5 foi adaptado de:
