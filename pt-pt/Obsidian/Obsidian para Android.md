...
To sync your notes with Obsidian on Android see [[Sincronizar as suas notas entre dispositivos]].
...
With the **device storage** option, your data is stored in a shared location on your device. This allows your Obsidian vault to be accessed by other apps and services, such as third-party [[Sincronizar as suas notas entre dispositivos|sync]] tools.
...
With this option you can use [[Introdução ao Obsidian Sync|Obsidian Sync]] and third-party syncing plugins available through [[Plugins da comunidade]], but you cannot use tools like Syncthing that rely on shared storage.
