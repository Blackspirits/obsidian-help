...
(function () {
  const LOCALES = [
    ...
    { code: 'pt-PT', label: 'Português (Portugal)', base: 'https://obsidian.md/pt-PT/help' },
...
// Locale UI strings — Portuguese (Portugal)
(function () {
  function apply() {
    var el;
    ...
    if (el) { el.textContent = 'Desenvolvido com Obsidian Publish'; el.href = 'https://obsidian.md/pt-PT/publish'; }
    el = document.querySelector('.graph-view-outer span:last-child');
    if (el) el.textContent = 'Grafo interactivo';
